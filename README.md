...
Если хочешь просто открыть и поставить приложение на телефон, смотри пошаговую инструкцию: [INSTALL_RU.md](INSTALL_RU.md). Там есть варианты через Android Studio, `adb install` и ручную установку APK.
